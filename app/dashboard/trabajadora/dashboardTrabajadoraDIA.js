...
angular.module('myApp.dashboard.dashboardTrabajadoraDIA', ['ngRoute','myApp.servicios'])
    ...
    .controller('dashboardTrabajadoraDIACtrl', ['$scope', '$firebaseObject', '$firebaseArray', '$mdDialog', '$http','$filter',
                      ...
                      $scope.ordenes.forEach(function (j) {
                          ...
                          traerOrdenesER.$loaded().then(function () {
                              ...
                              if (traerOrdenesER.realizado != false&&$scope.usuarioLogeado.uid==traerOrdenesER.idTrabajadora) {
                                ...
                                console.log(traerOrdenesER.psDescuento,"precio sin descuento");
                                  x.ordenesRealizadas.push(traerOrdenesER);
                                  $scope.servRealizados.push(traerOrdenesER);
                                console.log($scope.servRealizados, "asdasd");
                                  $scope.resumenDia.totalDia  += (traerOrdenesER.valor*$scope.getPorcentaje(traerOrdenesER.categoria,traerOrdenesER.idTrabajadora)/100);
